...
void TestApplication::run()
{
    ...
    std::shared_ptr<Mesh> mesh = Mesh::createMesh(plane, mat);

    std::shared_ptr<Mesh> mesh2 = Mesh::createMesh(plane, mat1);
    mesh2->transform.setPosition(Vector3F{2.0f, 0, 0});

    std::shared_ptr<Mesh> mesh3 = Mesh::createMesh(plane, mat);
